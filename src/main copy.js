/*
 * Description  :
 * Date         :2025-07-08 17:56:15
 * LastEditors  :Xuwei
 * LastEditTime :2025-07-10 15:44:17
 * FilePath     :\cloudflare-userscript\src\main copy.js
 */
...
mainEl.innerHTML =
  ...
  ${[
      ...
      .map(
          (key) =>
              `<li>${renderIcon("check", style.check).outerHTML}${t(key)}</li>`
      )
      .join("\n")}
  </ul>
  `;
