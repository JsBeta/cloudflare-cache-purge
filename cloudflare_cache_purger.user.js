...
// @match        *://*.anyviewer.com/*
// @match        *://*.anycloner.com/*
// @match        *://*.anyviewertech.com/*
// @match        *://*.anyviewertech.com/*
// @match        *://*.aomei.de/*
// @match        *://*.aomei.jp/*
// @match        *://*.aomei.fr/*
// @match        *://*.aomeisoftware.com/*
// @match        *://*.aomeitech.com/*
// @match        *://*.backup-utility.com/*
// @match        *://*.cbackup.com/*
// @match        *://*.cloudsharehub.com/*
// @match        *://*.diskpart.com/*
// @match        *://*.disk-partition.com/*
// @match        *://*.dynamic-disk.com/*
// @match        *://*.dynamic-disk-converter.com/*
// @match        *://*.easysavevideo.com/*
// @match        *://*.elfai.ai/*
// @match        *://*.extend-partition.com/*
// @match        *://*.fonetool.com/*
// @match        *://*.insdownloader.com/*
// @match        *://*.multcloud.com/*
// @match        *://*.multcloud.link/*
// @match        *://*.myrecover.com/*
// @match        *://*.ubackup.com/*
// @match        *://*.ultrapic.com/*
// @match        *://*.winfr.org/*
